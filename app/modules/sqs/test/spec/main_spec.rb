describe "main" do
  before(:all) do
    ...
    # Will be located at: /tmp/terraspace/test-harnesses/sqs-harness
    terraspace.build_test_harness(
      name: "sqs-harness",
      modules: {sqs: mod_path},
      # See: https://terraspace.cloud/docs/testing/test-harness/
      config: "spec/fixtures/config",
      tfvars: {sqs: "spec/fixtures/tfvars/test.tfvars"},
    )
    terraspace.up("sqs")
  end
  after(:all) do
  ...
  it "successful deploy" do
    ...
    # output_value = terraspace.output("sqs", "name")
