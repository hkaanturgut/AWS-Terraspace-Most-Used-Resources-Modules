describe "main" do
  before(:all) do
    ...
    # Will be located at: /tmp/terraspace/test-harnesses/vpc-harness
    terraspace.build_test_harness(
      name: "vpc-harness",
      modules: {vpc: mod_path},
      # See: https://terraspace.cloud/docs/testing/test-harness/
      config: "spec/fixtures/config",
      tfvars: {vpc: "spec/fixtures/tfvars/test.tfvars"},
    )
    terraspace.up("vpc")
  end
  after(:all) do
  ...
  it "successful deploy" do
    ...
    # output_value = terraspace.output("vpc", "name")
